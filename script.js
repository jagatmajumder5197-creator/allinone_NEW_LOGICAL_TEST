...
'https://script.google.com/macros/s/AKfycbwCMrfjGLtueeGMIXO0lcmtw808poNAnlhWuxObHG-__cE-ZFR3VKgCCVCePuKp5Obi/exec';
...
function getFmBreakdown(fm, writtenVal, studentClass, subject) {
  ...
  if (fm === 50) {
    const gkClasses = ['NUR (A)', 'NUR (B)', 'LKG_A', 'LKG_B'];
    ...
    const hindiClasses = ['UKG (A)', 'UKG (B)', 'I (A)', 'I (B)'];
